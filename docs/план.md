...
### Config
- Источники: Yaml для хранения entityes. Единый коталог config для файлов конфигурации (URI/логин/пароль/темы/идентификаторы).
...
main/
  ...
  config/         # config.hpp, загрузка Yaml
```
